...
export default function PrintCertificate() {
  ...
  return data && (
    ...
    >
      {/* 기존 상장 코드 그대로 복붙 */}
      <div className="text-left text-base mb-2">제{data.cert_data.cert_num}호</div>
      <h1 className="text-6xl font-bold tracking-wider mb-6">상&nbsp;&nbsp;&nbsp;&nbsp;장</h1>
      <div className="text-left text-2xl leading-10 grid grid-cols-2 mb-4 whitespace-nowrap">
      ...
      <div className="text-2xl leading-9 whitespace-pre-line mt-6">
